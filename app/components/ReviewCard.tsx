            ...
            <div className="p-8">
                <div className="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <span className="text-xs font-semibold text-orange-500">Popular Choice • New York, NY</span>
                    </div>
                    <button
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-50">
                    <div className="flex items-center gap-6">
                        ...
                        >
                            ...
                            <span className="text-sm font-extrabold">{isLiked ? '125' :'124'}</span>
                        </button>
                        <button className="flex items-center gap-2 text-gray-400 hover:text-orange-500 transition-all group/btn">
                            ...
                            <span className="text-sm font-extrabold">18</span>
                        </button>
                    </div>
                    ...
                    <div className="flex -space-x-3">
                        ...
                        <div className="w-8 h-8 rounded-full border-2 border-white bg-gray-900 text-[10px] text-white flex items-center justify-center font-bold">
                            +9
                        </div>
                    </div>
                </div>
